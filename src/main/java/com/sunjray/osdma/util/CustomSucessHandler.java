  ...
  public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
    ...
    authorities.forEach(authority -> {
      ...
      if (authority.getAuthority().equals("ROLE_HR")) {
        ...
        try {
          redirectStatergy.sendRedirect(request, response, "/pm/pm-create-site-code");
        }
        catch (Exception e) {
          e.printStackTrace();
        }
        ...
        try {
          redirectStatergy.sendRedirect(request, response, "/dw/sm-district-warehouse-product-list");
        }
        catch (Exception e) {
          e.printStackTrace();
        }
        ...
        try {
          redirectStatergy.sendRedirect(request, response, "/wa/sm-warehouse-a-dashboard");
        }
        catch (Exception e) {
          e.printStackTrace();
        }
