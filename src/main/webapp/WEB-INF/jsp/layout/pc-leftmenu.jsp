	...
	<div class="cui-menu-left-inner">
		<div class="cui-menu-left-logo">
			<a href="dashboards-alpha.html"> <img
				...
				src="../components/dummy-assets/common/img/logo-p.png" alt="" /> <img
				class="cui-menu-left-logo-toggled"
				src="../components/dummy-assets/common/img/logo-pmt.png" alt="" />
			</a>
		</div>
		<div class="cui-menu-left-scroll">
			<ul class="cui-menu-left-list cui-menu-left-list-root">
				<li class="cui-menu-left-item"><a href="pc-dashboard"
				...
				<li class="cui-menu-left-item"><a href="pc-dashboard"> <span
						class="cui-menu-left-icon icmn-books"></span> <span
						class="cui-menu-left-title">Project co-ordinator</span>
				</a></li>



				<li class="cui-menu-left-item"><a href="pc-site-survey"> <span
						class="cui-menu-left-icon icmn-books"></span> <span
						class="cui-menu-left-title">Site Survey</span>
				</a></li>
				...
				<li class="cui-menu-left-item"><a href="pc-material-request">

						<span class="cui-menu-left-title">Material Request</span>

				</a></li>
				<li class="cui-menu-left-item"><a href="pc-material-status">

						<span class="cui-menu-left-title">Material status</span>

				</a></li>
				<li class="cui-menu-left-item"><a href="pc-daily-work-status">
				...
				<li class="cui-menu-left-item"><a href="pc-fund-Request"> <span
						class="cui-menu-left-title">Fund Request</span>

				</a></li>
				<li class="cui-menu-left-item"><a
					href="pc-fund-requisition-status"> <span
						class="cui-menu-left-title">Fund Requestion Status</span>

				</a></li>
				<li class="cui-menu-left-item"><a href="pc-project-status">
